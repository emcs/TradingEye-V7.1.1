...
# set to be executable by your webserver (chmod 0755 cgidemo.cgi)
# If you must run cgi-scripts from a cgi-bin directory, move this file
# (cgidemo.cgi) there now.  Extra configuration will be required.
...
# details.  You may also choose to rename this script to cgidemo.pl
