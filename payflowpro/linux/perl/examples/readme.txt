...
available in the "Payflow Pro Developer's Guide".
{!+
The "Payflow Pro Developer's Guide" may be obtained from the
...
INSTALLATION
      ...
      For example, if your account values are user, vendor, partner, and
      pwd, then the resulting section would be as below:

            # Set the following variables to your account values:
            $USER         = "user";	#{!+ You must register with Verisign to get -!}
            $VENDOR       = "vendor";	# your USER/VENDOR/PARTNER/PWD
            $PARTNER      = "partner";
            $PWD          = "pwd";
      ...
      NT Platform:
        ...
        the Source Installation instructions above.
