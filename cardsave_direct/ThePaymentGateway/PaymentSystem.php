<?php
	...
	require_once(SITE_PATH."cardsave_direct/ThePaymentGateway/Common.php");
	require_once(SITE_PATH."cardsave_direct/ThePaymentGateway/SOAP.php");
	...
	class CardDetailsTransaction extends GatewayTransaction 
	{
	   	...
	   	public function getCustomerDetails()
	    {
	   	...
	   	public function processTransaction(GatewayOutput &$goGatewayOutput = null, TransactionOutputMessage &$tomTransactionOutputMessage = null)
	   	{
	        ...
	        //echo "<pre>";print_r($this->m_tdTransactionDetails);
	    	// transaction details
