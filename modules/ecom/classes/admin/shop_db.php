...
class c_shopDb
{
	...
	{		
		...
		`vDownloadablefile`, `vSku`, `vASIN`, `vISBN`, `vMPN`, `vUPC`,`fListPrice`, `fPrice`,`fRetailPrice`,
		`fItemWeight`,`fItemWidth`,`fItemHeight`,`fItemDepth`,`iInventory`, `iBackorder`, 
		...
		'".$this->request['layout']."',
		'$downloadfile',
		'".$this->request['sku']."','".$this->request['asin']."','".$this->request['isbn']."','".$this->request['mpn']."','".$this->request['upc']."',	
		...
		'".$this->libFunc->checkFloatValue($this->request['width'])."',
		'".$this->libFunc->checkFloatValue($this->request['height'])."',
		'".$this->libFunc->checkFloatValue($this->request['depth'])."',
