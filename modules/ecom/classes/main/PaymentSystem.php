<?php
	...
	require_once(SITE_PATH."modules/ecom/classes/main/SOAP.php");
	  	...
	  	function processTransaction(GetGatewayEntryPointsResult &$ggeprGetGatewayEntryPointsResult = null, GetGatewayEntryPointsOutputData &$ggepGetGatewayEntryPointsOutputData = null)
	   	{
	      	...
	      	$boTransactionSubmitted = GatewayTransaction::processTransactionBase($sSOAPClient, 'GetGatewayEntryPointsMessage', 'GetGatewayEntryPointsResult', 'GetGatewayEntryPointsOutputData', $sxXmlDocument, $goGatewayOutput, $lgepGatewayEntryPoints);
	   	...
	   	public function getCustomerDetails()
	    {
	   	...
	   	public function processTransaction(CardDetailsTransactionResult &$cdtrCardDetailsTransactionResult = null, TransactionOutputData &$todTransactionOutputData = null)
	   	{
	        ...
	        if ($this->m_cdCustomerDetails != null)
	        {
	       	...
	       	$boTransactionSubmitted = GatewayTransaction::processTransactionBase($sSOAPClient, 'PaymentMessage', 'CardDetailsTransactionResult', 'TransactionOutputData', $sxXmlDocument, $goGatewayOutput, $lgepGatewayEntryPoints);

			if ($boTransactionSubmitted)
			{
				$cdtrCardDetailsTransactionResult = SharedFunctionsPaymentSystemShared::getPaymentMessageGatewayOutput($sxXmlDocument->CardDetailsTransactionResult, $goGatewayOutput);
	
				$todTransactionOutputData = SharedFunctionsPaymentSystemShared::getTransactionOutputData($sxXmlDocument, $lgepGatewayEntryPoints);
			}
	...
	class CrossReferenceTransaction extends GatewayTransaction 
	{
	    ...
	    public function processTransaction(CrossReferenceTransactionResult &$crtrCrossReferenceTransactionResult = null, TransactionOutputData &$todTransactionOutputData = null)
	    {
	        ...
	        $boTransactionSubmitted = GatewayTransaction::processTransactionBase($sSOAPClient, 'PaymentMessage', 'CrossReferenceTransactionResult', 'TransactionOutputData', $sxXmlDocument, $goGatewayOutput, $lgepGatewayEntryPoints);

	       	if ($boTransactionSubmitted)
	        {
				$crtrCrossReferenceTransactionResult = SharedFunctionsPaymentSystemShared::getPaymentMessageGatewayOutput($sxXmlDocument->CrossReferenceTransactionResult, $goGatewayOutput);
	...
	class ThreeDSecureAuthentication extends GatewayTransaction
	{
		...
		public function processTransaction(ThreeDSecureAuthenticationResult &$tdsarThreeDSecureAuthenticationResult = null, TransactionOutputData &$todTransactionOutputData = null)
		{
	        ...
	        $boTransactionSubmitted = GatewayTransaction::processTransactionBase($sSOAPClient, 'ThreeDSecureMessage', 'ThreeDSecureAuthenticationResult', 'TransactionOutputData', $sxXmlDocument, $goGatewayOutput, $lgepGatewayEntryPoints);
	       	
	        if ($boTransactionSubmitted)
	      	{
				$tdsarThreeDSecureAuthenticationResult = SharedFunctionsPaymentSystemShared::getPaymentMessageGatewayOutput($sxXmlDocument->ThreeDSecureAuthenticationResult, $goGatewayOutput);
	...
	class GetCardType extends GatewayTransaction
	{
		...
		public function processTransaction(GetCardTypeResult &$gctrGetCardTypeResult = null, GetCardTypeOutputData &$gctodGetCardTypeOutputData = null)
		{
	        ...
	        $boTransactionSubmitted = GatewayTransaction::processTransactionBase($sSOAPClient, 'GetCardTypeMessage', 'GetCardTypeResult', 'GetCardTypeOutputData', $sxXmlDocument, $goGatewayOutput, $lgepGatewayEntryPoints);
			if ($boTransactionSubmitted)
	        {
	...
	{
		public static function getTransactionOutputData(SimpleXMLElement $sxXmlDocument, GatewayEntryPointList $lgepGatewayEntryPoints = null)
		{
			...
			if ($sxXmlDocument->TransactionOutputData->CustomVariables->GenericVariable)
			{
				...
				for ($nCount=0; $nCount < count($sxXmlDocument->TransactionOutputData->CustomVariables->GenericVariable); $nCount++)
				{
					...
					$gvGenericVariable = new GenericVariable();
		...
		public static function getCardTypeData($CardTypeDataTag)
		{
	   	...
	   	public static function getPaymentMessageGatewayOutput($GatewayOutput, GatewayOutput $goGatewayOutput = null)
	   	{
			...
			{
				$nPreviousStatusCode = new NullableInt(current($GatewayOutput->PreviousTransactionResult->StatusCode[0]));
			}
